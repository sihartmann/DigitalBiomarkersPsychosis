...
- **[participant name]_silences.txt**: Generated by ffmpeg. Contains data on speech and not speech in the particpant audio.
...
## FURTHER UPDATES:
- Add 'clean' parameter to automatically delete generally unnecessary files
- whisper transcription checker?